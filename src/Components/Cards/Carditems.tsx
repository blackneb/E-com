...
export const Carditems = (props: Catagories) => {
  ...
  return (
    <div className='h-42 w-32 hover:border-2 hover:border-gray-400 shadow hover:shadow- md:h-52 md:shadow md:w-48 rounded-md m-2 p-2'>
      <Link  to={`/detailed/${props.id}`}>
        <div className='h-32 w-28 flex justify-center md:h-36 md:w-44'>
          <img className='h-20 md:mt-0 rounded-md' src={URLPHOTO + images[0].toLocaleLowerCase()} alt=''/>
        </div>
      </Link>
      <div>
